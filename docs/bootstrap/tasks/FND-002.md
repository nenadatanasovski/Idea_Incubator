...
| ----------- | ------------------------- | ------- |
| 021\_\*.sql | Agent registration tables | Pending |
| 022\_\*.sql | Task queue tables         | Pending |
| 023\_\*.sql | Knowledge base tables     | Pending |
| 024\_\*.sql | Build execution tracking  | Pending |
