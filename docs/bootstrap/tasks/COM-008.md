...
SMTP_PORT=587
SMTP_USER=ned.python@gmail.com
SMTP_PASS=xxxx-xxxx-xxxx-xxxx  # App-specific password
SMTP_FROM=Vibe Platform <ned.python@gmail.com>
```
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  <h2 style="color: #333;">🤖 Vibe Platform</h2>
  ...
  private async sendWithRetry(message: EmailMessage, attempt: number = 1): Promise<SendResult> {
    const maxAttempts = 3;
