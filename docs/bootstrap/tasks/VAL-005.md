...
export class CoverageAnalyzer implements Validator {
  ...
  private checkThresholds(
    ...
    if (thresholds.branches && branches.percentage < thresholds.branches)
      return false;
    if (thresholds.functions && functions.percentage < thresholds.functions)
      return false;
    if (thresholds.statements && statements.percentage < thresholds.statements)
      return false;
