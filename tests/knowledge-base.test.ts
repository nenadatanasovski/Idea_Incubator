...
import {
  calculateSimilarity,
} from '../agents/sia/duplicate-detector.js';
...
describe('Knowledge Base', () => {
  describe('Confidence Tracking', () => {
    it('should have valid confidence config', () => {
      ...
      expect(CONFIDENCE_CONFIG.promotionThreshold).toBeGreaterThan(CONFIDENCE_CONFIG.initial);
    });
  ...
  describe('Confidence Config', () => {
    ...
    it('should have demotion threshold', () => {
      ...
      expect(CONFIDENCE_CONFIG.demotionThreshold).toBeLessThan(CONFIDENCE_CONFIG.promotionThreshold);
    });
    ...
    it('should have max and min confidence bounds', () => {
      ...
      expect(CONFIDENCE_CONFIG.maxConfidence).toBeGreaterThan(CONFIDENCE_CONFIG.minConfidence);
    });
  ...
  describe('Promotion Logic', () => {
    ...
    it('should have reasonable threshold gap', () => {
      const gap = CONFIDENCE_CONFIG.promotionThreshold - CONFIDENCE_CONFIG.demotionThreshold;
