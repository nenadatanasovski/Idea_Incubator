...
import { TaskLoader, createTaskLoader } from '../../agents/build/task-loader.js';
...
`;
  ...
  describe('orderByDependency', () => {
    ...
    it('should handle tasks with no dependencies', () => {
      const tasks: LoadedTask[] = [
        { id: 'T-003', phase: 'test', action: 'CREATE', file: 'c.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-001', phase: 'test', action: 'CREATE', file: 'a.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-002', phase: 'test', action: 'CREATE', file: 'b.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
      ];
    ...
    it('should handle complex dependency chains', () => {
      const tasks: LoadedTask[] = [
        { id: 'T-004', phase: 'test', action: 'CREATE', file: 'd.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: ['T-002', 'T-003'] },
        { id: 'T-001', phase: 'test', action: 'CREATE', file: 'a.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-003', phase: 'test', action: 'CREATE', file: 'c.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: ['T-001'] },
        { id: 'T-002', phase: 'test', action: 'CREATE', file: 'b.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: ['T-001'] },
      ];
  ...
  describe('getTasksByPhase', () => {
    ...
    it('should handle multiple tasks in same phase', () => {
      const tasks: LoadedTask[] = [
        { id: 'T-001', phase: 'database', action: 'CREATE', file: 'a.sql', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-002', phase: 'database', action: 'CREATE', file: 'b.sql', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-003', phase: 'types', action: 'CREATE', file: 'c.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
      ];
  ...
  describe('getTasksByStatus', () => {
    it('should filter tasks by status', () => {
      const tasks: LoadedTask[] = [
        { id: 'T-001', phase: 'test', action: 'CREATE', file: 'a.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-002', phase: 'test', action: 'CREATE', file: 'b.ts', status: 'completed', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-003', phase: 'test', action: 'CREATE', file: 'c.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
      ];
  ...
  describe('getPendingTasks', () => {
    it('should return only pending tasks', () => {
      const tasks: LoadedTask[] = [
        { id: 'T-001', phase: 'test', action: 'CREATE', file: 'a.ts', status: 'pending', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-002', phase: 'test', action: 'CREATE', file: 'b.ts', status: 'completed', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
        { id: 'T-003', phase: 'test', action: 'CREATE', file: 'c.ts', status: 'failed', requirements: [], gotchas: [], validation: { command: '', expected: '' }, dependsOn: [] },
      ];
