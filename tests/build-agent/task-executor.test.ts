...
describe("task-executor", () => {
  ...
  beforeEach(() => {
    ...
    (mockCodeGenerator.generate as ReturnType<typeof vi.fn>).mockResolvedValue(
      "// Generated code",
    );
    (mockFileWriter.write as ReturnType<typeof vi.fn>).mockResolvedValue({
      success: true,
    });
  ...
  describe("dependency ordering", () => {
    ...
    it("should detect circular dependencies", async () => {
      ...
      await expect(
        executor.execute([task1, task2], "/test/tasks.md"),
  ...
  describe("visualizeDependencyGraph", () => {
    ...
    it("should handle complex dependency graphs", () => {
      ...
      const dot = executor.visualizeDependencyGraph([
        task1,
        task2,
        task3,
        task4,
