...
console.log(`3. artifactStore object has all methods: ${hasAllMethods ? 'PASS' : 'FAIL'}`);
console.log(`4. New functions available via unified-artifact-store.ts: ${unifiedFunctionsAvailable ? 'PASS' : 'FAIL'}`);
...
(async () => {
  ...
  console.log('  - getArtifactsBySession function type:', typeof getArtifactsBySession);
