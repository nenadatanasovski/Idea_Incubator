...
console.log('Has competitor:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('competitor')));
console.log('Has B2B:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('B2B')));
console.log('Has funding:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('funding')));
console.log('Has technical:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('technical')));
console.log('Has legal:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('legal')));
console.log('Has marketing:', CONTENT_INFERENCE_RULES.some(r => r.trigger.keywords.includes('marketing')));
...
console.log('ClassificationRule test:', testRule.document, testRule.classification);
