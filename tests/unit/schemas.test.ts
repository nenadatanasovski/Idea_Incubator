...
describe('CriterionEvaluationSchema', () => {
  ...
  it('should reject score out of range', () => {
    expect(() => CriterionEvaluationSchema.parse({
      criterion: 'Test',
      category: 'problem',
      score: 0,
      confidence: 0.5,
...
describe('ArbiterVerdictSchema', () => {
  ...
  it('should reject invalid verdict', () => {
    expect(() => ArbiterVerdictSchema.parse({
      verdict: 'WINNER',
      reasoning: 'Test',
...
describe('SynthesisOutputSchema', () => {
  ...
  it('should reject invalid recommendation', () => {
    expect(() => SynthesisOutputSchema.parse({
...
describe('parseAgentResponse', () => {
  it('should parse valid JSON from text', () => {
    const text = 'Here is the response: {"evaluations": [{"criterion": "Test", "category": "problem", "score": 8, "confidence": 0.8, "reasoning": "Good"}]}';

    const result = parseAgentResponse(text, EvaluationResponseSchema, 'evaluation');
  ...
  it('should throw on invalid JSON', () => {
    ...
    expect(() => parseAgentResponse(text, EvaluationResponseSchema, 'evaluation'))
