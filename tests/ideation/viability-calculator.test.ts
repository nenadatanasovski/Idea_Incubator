  ...
  const webSearchResults: WebSearchResult[] = [
    {
      ...
      snippet: 'This technology is impossible with current methods and years away from reality. Requires million dollar funding.',
      source: 'TechSite',
    },
  ];

  return createBaseViabilityInput({ selfDiscovery, narrowingState, webSearchResults });
}
