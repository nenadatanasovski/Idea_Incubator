...
import {
  SessionManager,
} from '../../agents/ideation/session-manager.js';
    ...
    test('PASS: Creates a new session with profile ID', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['test-id', 'profile-123', 'active', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 0, 0]],
        }]),
      };
  ...
  describe('load', () => {
    ...
    test('PASS: Returns session for valid ID', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'active', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 0, 0]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
  ...
  describe('update', () => {
    test('PASS: Updates status field', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'completed', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 0, 0]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
    ...
    test('PASS: Updates multiple fields', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'active', 'narrowing', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 1000, 10]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
  ...
  describe('complete', () => {
    test('PASS: Sets status to completed', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'completed', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', 0, 0, 0]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
    ...
    test('PASS: Sets completed_at timestamp', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'completed', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', '2024-01-01T01:00:00.000Z', 0, 0, 0]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
  ...
  describe('abandon', () => {
    test('PASS: Sets status to abandoned', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [['session-123', 'profile-123', 'abandoned', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', 0, 0, 0]],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
    ...
    test('PASS: Returns active sessions for profile', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'profile_id', 'status', 'current_phase', 'entry_mode', 'started_at', 'last_activity_at', 'completed_at', 'handoff_count', 'token_count', 'message_count'],
          values: [
            ['session-1', 'profile-123', 'active', 'exploring', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 0, 0],
            ['session-2', 'profile-123', 'active', 'narrowing', 'discover', '2024-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z', null, 0, 0, 0],
          ],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
