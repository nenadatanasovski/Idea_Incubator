...
import {
  MessageStore,
} from '../../agents/ideation/message-store.js';
  ...
  describe('add', () => {
    test('PASS: Adds a message with required fields', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'session_id', 'role', 'content', 'buttons_shown', 'button_clicked', 'form_shown', 'form_response', 'web_search_results', 'token_count', 'created_at'],
          values: [['msg-123', 'session-123', 'user', 'Hello', null, null, null, null, null, 10, '2024-01-01T00:00:00.000Z']],
        }]),
      };
    ...
    test('PASS: Adds message with buttons', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'session_id', 'role', 'content', 'buttons_shown', 'button_clicked', 'form_shown', 'form_response', 'web_search_results', 'token_count', 'created_at'],
          values: [['msg-123', 'session-123', 'assistant', 'Choose one', '[{"id":"btn1","label":"Option 1"}]', null, null, null, null, 20, '2024-01-01T00:00:00.000Z']],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
      ...
      const message = await messageStore.add({
        ...
        role: 'assistant',
        content: 'Choose one',
        buttonsShown: [{ id: 'btn1', label: 'Option 1', value: 'opt1', style: 'primary' }],
      });
    ...
    test('PASS: Returns messages in order', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'session_id', 'role', 'content', 'buttons_shown', 'button_clicked', 'form_shown', 'form_response', 'web_search_results', 'token_count', 'created_at'],
          values: [
            ['msg-1', 'session-123', 'user', 'First', null, null, null, null, null, 10, '2024-01-01T00:00:00.000Z'],
            ['msg-2', 'session-123', 'assistant', 'Second', null, null, null, null, null, 20, '2024-01-01T00:01:00.000Z'],
          ],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
    ...
    test('PASS: Returns limited messages', async () => {
      ...
      const mockDb = {
        ...
        exec: vi.fn().mockReturnValue([{
          columns: ['id', 'session_id', 'role', 'content', 'buttons_shown', 'button_clicked', 'form_shown', 'form_response', 'web_search_results', 'token_count', 'created_at'],
          values: [
            ['msg-1', 'session-123', 'user', 'Recent 1', null, null, null, null, null, 10, '2024-01-01T00:00:00.000Z'],
            ['msg-2', 'session-123', 'assistant', 'Recent 2', null, null, null, null, null, 20, '2024-01-01T00:01:00.000Z'],
          ],
        }]),
      };
      vi.mocked(getDb).mockReturnValue(mockDb as unknown as ReturnType<typeof getDb>);
