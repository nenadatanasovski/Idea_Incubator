  ...
  describe('analyzeSearchResults', () => {
    ...
    test('PASS: Counts competitors', () => {
      const result = analyzeSearchResults([
        { query: 'test', results: [{ title: 'A', url: 'a.com', snippet: 'Competitor', source: 'a.com' }], timestamp: '' },
        { query: 'test', results: [{ title: 'B', url: 'b.com', snippet: 'Also competitor', source: 'b.com' }], timestamp: '' },
      ]);
    ...
    test('PASS: Identifies concerns from failed attempts', () => {
      const result = analyzeSearchResults([
        { query: 'test', results: [{ title: 'Failed Startup', url: 'a.com', snippet: 'Company X failed and shutdown due to', source: 'a.com' }], timestamp: '' },
      ]);
    ...
    test('PASS: Identifies opportunities from growth signals', () => {
      const result = analyzeSearchResults([
        { query: 'test', results: [{ title: 'Growth', url: 'a.com', snippet: 'emerging market with opportunity', source: 'a.com' }], timestamp: '' },
      ]);
    ...
    test('PASS: Returns empty arrays for no signals', () => {
      const result = analyzeSearchResults([
        { query: 'test', results: [{ title: 'Neutral', url: 'a.com', snippet: 'Just some text', source: 'a.com' }], timestamp: '' },
      ]);
