...
describe("SignalExtractor", () => {
  ...
  describe("extractCustomerType", () => {
    ...
    test("PASS: B2B beats B2C with more signals", () => {
      const result = extractCustomerType(
        "enterprise companies and corporations need this",
      );
      expect(result.value).toBe("B2B");
    });
  });
  ...
  describe("extractProductType", () => {
    ...
    test("PASS: Detects hybrid when multiple types present", () => {
      const result = extractProductType(
        "software platform with hardware device",
      );
      ...
      const result = extractMarketData([
        {
          ...
          snippet: "competitor to ProductX, they offer similar solutions",
        },
      ]);
      ...
      const result = extractMarketData([
        {
          title: "Market Report",
          url: "https://example.com",
          snippet: "There is a lack of solutions for small businesses",
        },
      ]);
      ...
      const result = extractMarketData([
        {
          title: "Trend Report",
          url: "https://example.com",
          snippet: "growing market demand for AI tools",
        },
      ]);
