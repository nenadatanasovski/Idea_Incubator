...
// Idea types
export const IdeaTypeSchema = z.enum(['business', 'creative', 'technical', 'personal', 'research']);
export type IdeaType = z.infer<typeof IdeaTypeSchema>;

// Evaluation categories
export const EvaluationCategorySchema = z.enum(['problem', 'solution', 'feasibility', 'fit', 'market', 'risk']);
...
export const RedTeamPersonaSchema = z.enum([
  'skeptic', 'realist', 'first-principles',
  'competitor', 'contrarian', 'edge-case'
]);
