...
export const ALL_CRITERIA: CriterionDefinition[] =
  Object.values(EVALUATION_CRITERIA).flat();
...
export function getCriterionByName(
  name: string,
...
export const SCORE_INTERPRETATIONS: ScoreInterpretation[] = [
  {
    ...
    description: "PURSUE aggressively",
  },
  {
    range: [7.0, 7.9],
    label: "Strong",
    recommendation: "PURSUE",
    description: "PURSUE with focus",
  },
  {
    range: [6.0, 6.9],
    label: "Promising",
    recommendation: "REFINE",
    description: "REFINE before proceeding",
  },
  {
    range: [5.0, 5.9],
    label: "Uncertain",
    recommendation: "REFINE",
    description: "REFINE significantly",
  },
  {
    range: [4.0, 4.9],
    label: "Weak",
    recommendation: "PAUSE",
    description: "PAUSE and reconsider",
  },
  {
    range: [1.0, 3.9],
    label: "Poor",
    recommendation: "ABANDON",
    description: "ABANDON or pivot",
  },
];
...
export function formatCriterionForPrompt(
