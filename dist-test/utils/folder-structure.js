 ...
 */
export async function createUserFolder(userSlug) {
 ...
 */
export async function createDraftFolder(userSlug) {
 ...
 */
function generateProfileTemplate(userSlug, created) {
    return `---
slug: ${userSlug}
name: ""
created: ${created}
 ...
 */
export async function createIdeaFolder(userSlug, ideaSlug, ideaType, parent) {
    // Ensure user folder exists first
    await createUserFolder(userSlug);
    const usersRoot = getUsersRoot();
 ...
 */
function createTemplateFile(ideaFolder, relativePath, content) {
 ...
 */
function createMetadataFiles(ideaFolder, templateVars, parent) {
 ...
 */
function generateReadmeTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
 ...
 */
function generateDevelopmentTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateTargetUsersTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateProblemSolutionTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateBusinessModelTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateTeamTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateMarketTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateCompetitiveTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateAssumptionsTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateBriefTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateMvpScopeTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateArchitectureTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateGtmTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generatePitchTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateContactsTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
function generateSpecTemplate(vars) {
    return `---
id: ${vars.id}
title: ${vars.title}
idea_type: ${vars.idea_type}
 ...
 */
export async function renameDraftToIdea(userSlug, draftId, ideaSlug, ideaType) {
    const usersRoot = getUsersRoot();
 ...
 */
async function updateDatabaseReferences(userSlug, oldSlug, newSlug) {
    // Dynamic import to avoid circular dependencies
    const { run, saveDb } = await import('../database/db.js');
    // Update ideation_sessions
    await run(`UPDATE ideation_sessions SET idea_slug = ? WHERE user_slug = ? AND idea_slug = ?`, [newSlug, userSlug, oldSlug]);
    // Update ideation_artifacts
    await run(`UPDATE ideation_artifacts SET idea_slug = ? WHERE user_slug = ? AND idea_slug = ?`, [newSlug, userSlug, oldSlug]);
