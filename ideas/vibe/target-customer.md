# Vibe — Target Customer Definition

**Purpose:** Address the viability risk "Target customer not clearly defined"
...
Vibe's target customer is **the Capable Dreamer** — someone with business ideas and domain expertise who lacks the technical skills, time, or structured process to turn those ideas into reality.

**Primary Segment (Beachhead):** Corporate employees with side project ambitions
**Secondary Segments:** Aspiring solopreneurs, small business owners, domain experts

---

## The Capable Dreamer Profile
...
1. **Ideas sitting in notebooks** — Have captured ideas but taken no action
2. **Failed previous attempts** — Tried no-code tools, gave up frustrated
3. **Busy lives** — Full-time work, family, or other commitments
4. **Want to "finally do something"** — Emotional motivation beyond pure profit
5. **Not looking for escape** — Want supplemental income, not necessarily quitting their job

---

## Primary Segment: Corporate Side-Hustler

**The beachhead market — who we focus on first.**
...
- Listen to podcasts like "My First Million" or "Indie Hackers"
- Google "how to build an app without coding"
- Have a notes folder called "Business Ideas" they never act on
...
### Primary Message (Corporate Side-Hustler)

**Headline:** "Finally turn your idea into a real app"
...
- Users want to export code

### Risk: Can't Reach Them

**Mitigation:** Build in public on Twitter/X. Founder's constraint (can't use LinkedIn) forces community-building which aligns with target audience behavior.

### Risk: Won't Pay

**Mitigation:** Credit system with generous free tier validates interest before requiring payment. Users who exhaust credits demonstrate real demand.
...
## Summary: The One-Sentence Customer

**Vibe is for corporate employees with business ideas who want to finally build something of their own but lack the technical skills and structured process to do it.**

---

## Next Steps

1. [ ] Review this definition with 3-5 people matching the profile
2. [ ] Create interview script for customer discovery
3. [ ] Set up tracking for customer segment in analytics
4. [ ] Draft landing page copy using messaging framework
5. [ ] Identify 10 Reddit/Twitter threads where these users congregate
