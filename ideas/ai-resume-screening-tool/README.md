...
Automates repetitive recruiting tasks — resume screening, candidate matching, data entry. Observed pain point from recruiters who tried existing tools but still struggle with accuracy, usability, integrations, and cost.
...
✅ **Market Validated** - Ready for Ideation

## Viability Score

**72%** (Medium-High Confidence)
...
- Harvard study: 10M+ qualified candidates rejected by rigid AI filters
...
**Enterprise ($5K+/yr):** Greenhouse, Lever, HireVue, Workday
**Mid-Market ($1-5K/yr):** SmartRecruiters, Bullhorn, iCIMS
**SMB (<$1K/yr):** Manatal, BreezyHR, Zoho Recruit, JazzHR
**Well-Funded Startups:** Mercor ($100M @ $2B valuation), Tezi
...
- Top 10 integrations covered

## Next Steps

1. [ ] Customer interviews (10-15 recruiters) to validate positioning
2. [ ] Define MVP feature set with compliance core
3. [ ] Prototype bias testing framework
4. [ ] Research pricing willingness-to-pay
5. [ ] Identify 3-5 priority integrations

## Related Files

- [Validation Report](research/validation-report.md)
