...
try {
  ...
  const phases = [
    'Frontend Shell', 'Data Model', 'Backend API', 'Frontend + API',
    'WebSocket', 'Telegram Bot', 'Orchestrator', 'Clarification Agent',
    'Agent Spawner', 'Agent Memory', 'QA Validation', 'Human Sim Agent',
    'Wave Execution', 'Planning Agent', 'Self-Improvement', 'Polish'
  ];
