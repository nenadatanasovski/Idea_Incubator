...
export function seedPhase1Tests(): void {
  ...
  const testCases = [
      ...
      steps: [
        {
          ...
          command: 'test -f parent-harness/dashboard/src/components/AgentStatusCard.tsx',
          expectedExitCode: 0,
          assertions: [
            {
              type: 'exists' as const,
              target: 'parent-harness/dashboard/src/components/AgentStatusCard.tsx',
        ...
        },
        {
          ...
          command: 'cat parent-harness/dashboard/src/components/AgentStatusCard.tsx',
          expectedExitCode: 0,
      ...
      steps: [
        {
          ...
          command: 'test -f parent-harness/dashboard/src/components/EventStream.tsx',
          expectedExitCode: 0,
          assertions: [
            {
              type: 'exists' as const,
        ...
        },
        {
          ...
          command: 'cat parent-harness/dashboard/src/components/EventStream.tsx',
          expectedExitCode: 0,
      ...
      steps: [
        {
          ...
          command: 'test -f parent-harness/dashboard/src/components/TaskCard.tsx',
          expectedExitCode: 0,
          assertions: [
            {
              type: 'exists' as const,
    ...
    },
    {
      ...
      name: 'Basic Routing',
      description: 'Verify React Router setup with Dashboard, Tasks, and Sessions pages',
      priority: 'P0' as const,
      steps: [
        {
      ...
      steps: [
        {
          ...
          command: 'test -f parent-harness/dashboard/src/components/NotificationCenter.tsx',
          expectedExitCode: 0,
          assertions: [
            {
              type: 'exists' as const,
              target: 'parent-harness/dashboard/src/components/NotificationCenter.tsx',
        ...
        },
        {
          ...
          command: 'cat parent-harness/dashboard/src/components/NotificationCenter.tsx',
          expectedExitCode: 0,
