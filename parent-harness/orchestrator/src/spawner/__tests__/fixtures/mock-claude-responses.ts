...
export const successResponses = {
  ...
  multiFileSuccess: {
    ...
    is_error: false,
    result:
      "TASK_COMPLETE: Successfully coordinated changes across 3 files:\n- database/migrations/001_create_users.sql\n- server/routes/users.ts\n- frontend/src/components/UserList.tsx\nAll files compiled successfully.",
    total_cost_usd: 0.05,
    usage: {
      input_tokens: 1500,
      output_tokens: 800,
  ...
  frontendGeneration: {
    ...
    is_error: false,
    result:
      "TASK_COMPLETE: Generated React component UserCard.tsx with:\n- TypeScript interface for props\n- Tailwind CSS styling\n- Responsive design\n- Accessibility attributes",
    total_cost_usd: 0.04,
    usage: {
      input_tokens: 1000,
      output_tokens: 1500,
  ...
  migrationGeneration: {
    ...
    is_error: false,
    result:
      "TASK_COMPLETE: Generated SQL migration 001_create_users_table.sql with:\n- CREATE TABLE users statement\n- Indexes for performance\n- Foreign key constraints\n- Rollback migration included",
    total_cost_usd: 0.02,
    usage: {
      input_tokens: 800,
      output_tokens: 600,
