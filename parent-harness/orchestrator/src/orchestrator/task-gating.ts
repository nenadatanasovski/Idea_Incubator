...
export function isTestLikeTask(task: Pick<Task, 'category' | 'display_id'>): boolean {
 ...
 */
export function isRunnableProductionTask(task: Pick<Task, 'category' | 'display_id'>): boolean {
