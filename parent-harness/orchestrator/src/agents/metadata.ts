...
export const AGENT_METADATA: Record<string, AgentMetadata> = {
  ...
  decomposition_agent: {
    ...
    tools: ['Read'],
    outputFormat: 'Subtask list with Title, Description, Pass Criteria, Dependencies, Wave',
    telegram: {
  ...
  evaluator_agent: {
    ...
    tools: ['Read'],
    outputFormat: 'Complexity (LOW-VERY_HIGH), Effort (hours), Risk, Recommendation',
    telegram: {
  ...
  planning_agent: {
    ...
    type: 'planning',
    emoji: '⭐',
    description: 'Strategic brain - analyzes codebase and creates improvement tasks',
