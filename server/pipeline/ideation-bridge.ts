...
export async function checkSpecReadiness(ideaId: string): Promise<{
  ...
  try {
    ...
    const { completionScore, confidenceScore, milestones } =
    ...
    if (!milestones.solutionClear)
      missingMilestones.push("Solution description");
