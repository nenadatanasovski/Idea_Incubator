...
import { createTaskResultCollector, TaskResultCollector } from '../task-result-collector.js';
...
describe('TaskResultCollector', () => {
  ...
  describe('recordFailure', () => {
    it('should update database with failure', async () => {
      ...
      await collector.recordFailure(executionId, 'Task failed due to error', false);
  ...
  describe('getPendingCount', () => {
    it('should return count of pending executions', async () => {
      ...
      await collector.startExecution(mockTask, '/path/to/tasks.md', 'build-123', 'agent1');
      expect(collector.getPendingCount()).toBe(1);

      await collector.startExecution(mockTask, '/path/to/tasks.md', 'build-123', 'agent2');
