 ...
 */
router.get('/:taskId/appendices/resolved', async (req: Request, res: Response) => {
  try {
    const { taskId } = req.params;
...
router.post('/:taskId/appendices', async (req: Request, res: Response) => {
  try {
    const { taskId } = req.params;
    const { appendixType, content, referenceId, referenceTable, position } = req.body;
 ...
 */
router.put('/:taskId/appendices/:appendixId', async (req: Request, res: Response) => {
  try {
 ...
 */
router.delete('/:taskId/appendices/:appendixId', async (req: Request, res: Response) => {
  try {
    const { appendixId } = req.params;
 ...
 */
router.post('/:taskId/appendices/reorder', async (req: Request, res: Response) => {
  try {
    const { taskId } = req.params;
