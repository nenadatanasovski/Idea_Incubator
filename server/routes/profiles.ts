...
router.get('/:id/ideas', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.post('/:profileId/link/:ideaSlug', asyncHandler(async (req, res) => {
...
router.delete('/:profileId/link/:ideaSlug', asyncHandler(async (req, res) => {
  const { profileId, ideaSlug } = req.params;
