...
const TEMPLATES: Record<string, MessageTemplate> = {
  ...
  "greeting.welcome": {
    ...
    telegramText:
      "👋 Welcome to the Vibe {{agentType}} Bot!\n\n" +
    ...
    emailText:
      "Welcome to the Vibe {{agentType}} system. Use this channel to receive updates and answer questions from the {{agentType}} agent.",
    variables: ["agentType"],
  },
  ...
  "status.agent_completed": {
    ...
    emailText:
      "The {{agentType}} agent has completed processing.\n\n{{summary}}\n\nDuration: {{duration}}\nQuestions answered: {{questionsAnswered}}",
    variables: [
      "agentType",
      "summary",
      "duration",
...
export class MessageTemplates {
  ...
  getTemplate(templateId: string): MessageTemplate | null {
    return (
      this.customTemplates.get(templateId) || TEMPLATES[templateId] || null
    );
  }
