...
```typescript
// Agent missing:
health_status, current_iteration, current_step, error_count,
memory_mb, cpu_percent

// Task missing:
progress_percent, iteration_count, total_iterations,
estimated_completion, token_usage, files_modified,
last_error, error_details

// AgentSession missing:
progress_percent, health_status, current_iteration,
iteration_rate, last_activity, time_since_heartbeat
