...
const getAlignmentIcon = (
  alignment: "favorable" | "neutral" | "challenging" | undefined,
) => {
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 text-white">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* Fit Score */}
            <div
              className={`px-3 py-1 rounded-full text-lg font-bold ${getScoreColor(strategy.fitWithProfile)}`}
            >
      ...
      <div className="p-6 space-y-6">
        ...
        {goalAlignment && (
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div
                className={`p-3 rounded-lg text-center ${goalAlignment.meetsIncomeTarget ? "bg-green-50" : "bg-red-50"}`}
              >
                <div
                  className={`text-2xl mb-1 ${goalAlignment.meetsIncomeTarget ? "text-green-600" : "text-red-600"}`}
                >
                  {goalAlignment.meetsIncomeTarget ? "✓" : "✗"}
                </div>
                <div className="text-xs text-gray-600">Meets Income Target</div>
                {goalAlignment.gapToTarget &&
                  !goalAlignment.meetsIncomeTarget && (
              ...
              <div
                className={`p-3 rounded-lg text-center ${goalAlignment.runwaySufficient ? "bg-green-50" : "bg-red-50"}`}
              >
                <div
                  className={`text-2xl mb-1 ${goalAlignment.runwaySufficient ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div
                className={`p-3 rounded-lg text-center ${goalAlignment.investmentFeasible ? "bg-green-50" : "bg-red-50"}`}
              >
                <div
                  className={`text-2xl mb-1 ${goalAlignment.investmentFeasible ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div
                className={`p-3 rounded-lg text-center ${
                  goalAlignment.timelineAlignment === "faster" ||
                  goalAlignment.timelineAlignment === "aligned"
                    ? "bg-green-50"
        ...
        {profileFitBreakdown && (
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {profileFitBreakdown.strengths &&
                profileFitBreakdown.strengths.length > 0 && (
                  <div className="bg-green-50 rounded-lg p-4">
                    <h5 className="text-sm font-medium text-green-700 mb-2">
                      Strengths
                    </h5>
              ...
              {profileFitBreakdown.gaps &&
                profileFitBreakdown.gaps.length > 0 && (
            ...
            {profileFitBreakdown.suggestions &&
              profileFitBreakdown.suggestions.length > 0 && (
        ...
        {allocationFeasibility && (
          <section>
            ...
            <div
              className={`rounded-lg p-4 ${allocationFeasibility.overallFeasible ? "bg-green-50 border border-green-200" : "bg-amber-50 border border-amber-200"}`}
            >
              ...
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <span
                    className={
                      allocationFeasibility.budgetSufficient
                        ? "text-green-600"
                        : "text-red-600"
                    }
                  >
                    {allocationFeasibility.budgetSufficient
                      ? "OK"
                      : `Gap: ${formatCurrency(allocationFeasibility.budgetGap || 0)}`}
                  </span>
                </div>
                <div>
                  ...
                  <span
                    className={
                      allocationFeasibility.timeSufficient
                        ? "text-green-600"
                        : "text-red-600"
                    }
                  >
                    {allocationFeasibility.timeSufficient
                      ? "OK"
                      : `Gap: ${allocationFeasibility.timeGap || 0} hrs/wk`}
                  </span>
                </div>
                <div>
                  ...
                  <span
                    className={
                      allocationFeasibility.runwaySufficient
                        ? "text-green-600"
                        : "text-red-600"
                    }
                  >
                    {allocationFeasibility.runwaySufficient
                      ? "OK"
                      : `Gap: ${allocationFeasibility.runwayGap || 0} mo`}
                  </span>
                </div>
              </div>
              ...
              {/* Adjustment Options */}
              {!allocationFeasibility.overallFeasible &&
                allocationFeasibility.adjustmentOptions &&
                allocationFeasibility.adjustmentOptions.length > 0 && (
