    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg p-3 shadow-sm">
          ...
          <span
            className={`inline-block text-xs px-2 py-0.5 rounded-full mt-2 ${getFitColor(
              summary.primaryOpportunity.fit,
            )}`}
          >
        ...
        <div className="bg-white rounded-lg p-3 shadow-sm">
          ...
          <p
            className={`font-medium mt-1 truncate ${getSeverityColor(
              summary.criticalRisk.severity,
            )}`}
          >
        ...
        <div className="bg-white rounded-lg p-3 shadow-sm">
          ...
          <p
            className={`text-xl font-bold mt-1 ${getUrgencyColor(
              summary.timingAssessment.urgency,
            )}`}
          >
