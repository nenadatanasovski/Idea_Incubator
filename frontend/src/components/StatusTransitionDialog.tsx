...
export default function StatusTransitionDialog({
  ...
  const requiresReason =
    selectedStatus === "paused" || selectedStatus === "abandoned";
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="p-4">
          <p className="text-sm text-gray-600 mb-4">
            Current status:{" "}
            <span
              className={`font-medium ${statusConfig[currentStatus].color.replace("text-", "text-")}`}
            >
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {availableTransitions.map((status) => {
                    ...
                    const description =
                      transitionDescriptions[`${currentStatus}-${status}`];
        ...
        <div className="flex justify-end gap-3 p-4 border-t bg-gray-50 rounded-b-lg">
          ...
          <button
            ...
            disabled={
              !selectedStatus || isLoading || (requiresReason && !reason.trim())
            }
