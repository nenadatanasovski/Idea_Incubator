  ...
  return (
    <div className="button-group flex flex-wrap gap-2">
      {buttons.map((button) => {
        ...
        const isDisabled =
          disabled || (selectedId !== undefined && !isSelected);

        const baseClasses =
          "px-4 py-2 rounded-lg text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2";
        const styleClasses = getButtonStyles(
          button.style,
          isSelected,
          isDisabled,
        );
