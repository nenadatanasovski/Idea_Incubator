...
const BLOCK_TYPES: { value: BlockType; label: string; icon: string; description: string }[] = [
  { value: 'knowledge', label: 'Knowledge', icon: '📚', description: 'Verified facts, patterns, insights' },
  { value: 'decision', label: 'Decision', icon: '⚖️', description: 'Choices made with rationale' },
  { value: 'assumption', label: 'Assumption', icon: '🤔', description: 'Unverified beliefs to test' },
  { value: 'question', label: 'Question', icon: '❓', description: 'Open unknowns to investigate' },
  { value: 'requirement', label: 'Requirement', icon: '📋', description: 'Constraints, must-haves' },
  { value: 'task', label: 'Task', icon: '✅', description: 'Work items, actions' },
  { value: 'proposal', label: 'Proposal', icon: '💡', description: 'Suggested changes awaiting approval' },
  { value: 'artifact', label: 'Artifact', icon: '📦', description: 'Outputs (code, docs, specs)' },
  { value: 'evidence', label: 'Evidence', icon: '🔍', description: 'Validation data, proof' },
];
