...
function FilterSection({
  ...
  return (
    <div className="border-b border-gray-200 last:border-b-0">
      <button
        onClick={onToggle}
        className="w-full py-2.5 flex items-center justify-between text-sm font-medium text-gray-700 hover:text-gray-900"
      >
  ...
  return (
    <div className="space-y-2">
      ...
      >
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-white border-2 border-blue-500 rounded-full shadow-sm pointer-events-none"
