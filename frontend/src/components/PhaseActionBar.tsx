import { Lightbulb, Play, Edit2, GitBranch, History, Trash2, Loader2, Pause, RefreshCw, ChevronRight } from 'lucide-react'
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        action.variant === 'danger' && 'btn-secondary text-red-600 hover:text-red-700 hover:bg-red-50',
